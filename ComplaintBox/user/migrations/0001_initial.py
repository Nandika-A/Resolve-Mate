    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('worker', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='user.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
            fields=[
                ...
                ('Worker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.workerprofile')),
